...
import CapGenerator.load_data as ld
import CapGenerator.generate_model as gen
import argparse
...
if __name__ == '__main__':
  ...
  # load the tokenizer
  tokenizer = load(open('/Users/mananchugh/Desktop/Spring 2020/CS6700/Image-Captioning/models/tokenizer.pkl', 'rb'))
  index_word = load(open('/Users/mananchugh/Desktop/Spring 2020/CS6700/Image-Captioning/models/index_word.pkl', 'rb'))
  ...
  if args.model:
    ...
    filename = '/Users/mananchugh/Desktop/Spring 2020/CS6700/Image-Captioning/models/model_weight.h5'
