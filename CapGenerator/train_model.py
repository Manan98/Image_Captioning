...
def train_model(weight = None, epochs = 10):
  ...
  # save the tokenizer
  dump(tokenizer, open(project_dir+'/models/tokenizer.pkl', 'wb'))
  # index_word dict
  index_word = {v: k for k, v in tokenizer.word_index.items()}
  # save dict
  dump(index_word, open(project_dir+'/models/index_word.pkl', 'wb'))
  ...
  filepath = '/Users/mananchugh/Desktop/Spring 2020/CS6700/Image-Captioning/models/model-ep{epoch:03d}-loss{loss:.3f}-val_loss{val_loss:.3f}.h5'
  ...
  try:
      model.save('/Users/mananchugh/Desktop/Spring 2020/CS6700/Image-Captioning/models/wholeModel.h5', overwrite=True)
      model.save_weights('/Users/mananchugh/Desktop/Spring 2020/CS6700/Image-Captioning/models/weights.h5',overwrite=True)
  except:
